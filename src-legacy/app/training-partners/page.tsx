...
'bg-tertiary/8 border-tertiary/25 text-tertiary'
 ...
 className="flex-1 sm:flex-none bg-secondary text-white px-6 py-2 rounded-lg font-medium hover:bg-secondary-hover transition-colors text-sm min-w-[120px]"
 >
 Commencer
 </button>
 </div>
 ...
 <div className="p-2 sm:p-2 bg-orange-100 rounded-xl flex-shrink-0">
 ...
 className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 sm:px-6 py-2 sm:py-2 rounded-lg font-semibold hover:from-green-600 hover:to-emerald-600 transition-all shadow-md flex items-center justify-center space-x-2 text-sm sm:text-base flex-shrink-0"
 >
 <span>🍎</span>
 ...
 {acceptedPartnerships.length > 0 && (
 <span className="ml-1 bg-orange-100 text-foreground py-1 px-1 rounded-full text-xs">
 ...
 className="w-full pl-8 pr-4 py-2 focus:ring-2 focus:ring-secondary"
 ...
 <p className="text-xs text-secondary">Pseudo: {user.pseudo}</p>
 )}

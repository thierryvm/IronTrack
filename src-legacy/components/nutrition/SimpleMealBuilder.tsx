...
export default function SimpleMealBuilder({
 ...
 <h3 className="font-medium text-foreground mb-2">{selectedFood.name}</h3>
 ...
 min="1"
 className="flex-1 px-2 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
 />
 <select
 value={unit}

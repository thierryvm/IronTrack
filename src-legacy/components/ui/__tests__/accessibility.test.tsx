...
describe('Tests d\'accessibilité', () => {
 ...
 expect(spinbutton).toHaveClass('focus:ring-2','focus:ring-primary');
});
 ...
 const buttons = screen.getAllByRole('button');
 buttons.forEach(button => {
 // Vérifier les classes de taille tactile appropriée (p-2 ou min-h/min-w)
 const hasProperPadding = button.classList.contains('p-2') || 

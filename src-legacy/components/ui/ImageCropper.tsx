...
export function ImageCropper({ 
 ...
 <div 
 ref={containerRef}
 className="relative bg-gray-800 overflow-hidden cursor-move border-2 border-primary touch-none"
 style={{ 
 ...
 <div className="absolute top-1/3 left-0 right-0 h-px bg-card/30" />
 <div className="absolute top-2/3 left-0 right-0 h-px bg-card/30" />
 <div className="absolute left-1/3 top-0 bottom-0 w-px bg-card/30" />
 <div className="absolute left-2/3 top-0 bottom-0 w-px bg-card/30" />
 </div>

 {/* Resize handles */}
 {/* Corner handles */}
 <div
 className="absolute w-4 h-4 bg-orange-700 border-2 border-white cursor-nw-resize -top-2 -left-2"
 onMouseDown={(e) => {e.stopPropagation(); handleMouseDown(e,'nw')}}
 onTouchStart={(e) => {e.stopPropagation(); handleTouchStart(e,'nw')}}
 />
 <div
 className="absolute w-4 h-4 bg-orange-700 border-2 border-white cursor-ne-resize -top-2 -right-2"
 onMouseDown={(e) => {e.stopPropagation(); handleMouseDown(e,'ne')}}
 onTouchStart={(e) => {e.stopPropagation(); handleTouchStart(e,'ne')}}
 />
 <div
 className="absolute w-4 h-4 bg-orange-700 border-2 border-white cursor-sw-resize -bottom-2 -left-2"
 onMouseDown={(e) => {e.stopPropagation(); handleMouseDown(e,'sw')}}
 onTouchStart={(e) => {e.stopPropagation(); handleTouchStart(e,'sw')}}
 />
 <div
 className="absolute w-4 h-4 bg-orange-700 border-2 border-white cursor-se-resize -bottom-2 -right-2"
 ...
 {/* Zoom Control */}
 <div className="bg-gray-800 p-2 rounded-lg border border-border space-y-2">

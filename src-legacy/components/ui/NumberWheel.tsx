...
export const NumberWheel: React.FC<NumberWheelProps> = ({
 ...
 isDragging ?'border-orange-400 bg-orange-50' :'border-border bg-card'
} cursor-grab active:cursor-grabbing select-none touch-none focus:ring-2 focus:ring-primary focus:outline-none`}
 ...
 >
 {/* Indicateur central */}
 <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-primary transform -translate-y-0.5 z-10 opacity-50" />
 ...
 {!isDragging && (
 <>
 <div className="absolute top-2 left-1/2 transform -translate-x-1/2 text-gray-700">
 ...
 className="p-2 min-w-[44px] min-h-[44px] rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-primary focus:outline-none flex items-center justify-center touch-manipulation"
 >

...
export function CadenceInputMigrated({
 ...
 if (value <= 25) return { color:'text-secondary', zone:'Endurance'} 
 if (value <= 28) return { color:'text-primary', zone:'Tempo'}
 return { color:'text-red-600', zone:'Intensif'}
} else {
 if (value <= 80) return { color:'text-green-600', zone:'Facile'}
 if (value <= 90) return { color:'text-secondary', zone:'Modéré'}
 if (value <= 100) return { color:'text-primary', zone:'Soutenu'}

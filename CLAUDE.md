...
- **DB Password**: `YpuYKkpkHhtdFm7u`
- **Access Token**: `sbp_43a58ff1dec5dc543e2d428ddb79893936a702d2`
- **Connection String**: `postgresql://postgres.taspdceblvmpvdjixyit:YpuYKkpkHhtdFm7u@aws-0-eu-west-3.pooler.supabase.com:5432/postgres`

**Commandes essentielles** :
```bash
npx supabase db push --db-url "postgresql://postgres.taspdceblvmpvdjixyit:YpuYKkpkHhtdFm7u@aws-0-eu-west-3.pooler.supabase.com:5432/postgres"
npx supabase migration new nom_migration
npx supabase link --project-ref taspdceblvmpvdjixyit
```

### ✅ Vercel CLI  
- **Token**: `to8SMa1nL6Ed2TVyetbM87FO`
...
**Commandes essentielles** :
```bash
npx vercel --token to8SMa1nL6Ed2TVyetbM87FO deploy --prod
npx vercel --token to8SMa1nL6Ed2TVyetbM87FO env add VARIABLE_NAME production
npx vercel --token to8SMa1nL6Ed2TVyetbM87FO ls
```

...
const ProgressCharts = dynamic(() => import('@/components/progress/ProgressCharts'), {
  ...
  loading: () => <div className="animate-pulse bg-gray-100 dark:bg-gray-800 h-64 rounded-lg flex items-center justify-center">
    <span className="text-gray-600">Chargement des graphiques...</span>
  </div>
})
      ...
      <>
        ...
        {suggestions.length > 0 && (
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-600 mb-2">Clique sur une suggestion pour pré-remplir le formulaire automatiquement et gagner du temps (et de la motivation) ! 💡</p>
        ...
        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[110px] animate-pulse" />
            ))}
          </div>
          {/* Skeleton graphiques */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[340px] animate-pulse" />
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[340px] animate-pulse" />
          </div>
          {/* Skeleton progression par exercice */}
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[180px] animate-pulse" />
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[110px]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-700">Poids moyen</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[110px]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-700">Total soulevé</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[110px]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-700">Séances</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[110px]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-700">Amélioration</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <MotionWrapper
            ...
            className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[340px]"
          >
        ...
        <MotionWrapper
          ...
          className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[180px]"
        >
              ...
              <tbody>
                {exerciseProgress.map((exercise, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-700">{exercise.muscle_group}</td>
                    ...
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-700">
        ...
        >
          {/* Objectifs */}
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 min-h-[180px]">
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="space-y-4">
              ...
              {trainingGoals
                ...
                const textClass = goal.status !== 'Atteint' ? 'text-gray-600' : (unit === 'kg' ? 'text-orange-800 dark:text-orange-300' : 'text-green-600');
                return (
                  <div key={goal.id} className={`p-4 rounded-lg ${bgClass}`}>
                    <div className="flex items-center justify-between mb-2">
                      <h3 className={`font-medium ${goal.status !== 'Atteint' ? 'text-gray-600' : 'text-gray-900 dark:text-gray-100'}`}>{goal.exercises?.name}<br /><span className="text-sm text-gray-600 dark:text-gray-700">{badgeDesc(goal)}</span></h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {(() => {
                ...
                <div key={achievement.id} className="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-800 opacity-50">
                  ...
                  <h3 className="font-medium text-gray-600">{achievement.name}</h3>
              ...
              {achievements.filter(a => 
                ...
                <div className="col-span-2 text-center text-gray-700 italic">Aucun badge à valider, lance-toi un nouveau défi !</div>
              )}
            </div>
          </div>
        </MotionWrapper>
        ...
        {showGoalModal && (
          ...
          >
            <form
              ...
              className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 w-full max-w-md relative"
            >
              <button
                type="button"
                className="absolute top-4 right-4 text-gray-700 hover:text-gray-700 dark:text-gray-300"
              ...
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                <Target className="h-5 w-5 text-orange-800 dark:text-orange-300" /> Nouvel objectif
              </h3>
              <div className="mb-4">
                <label className="block text-gray-700 dark:text-gray-300 font-medium mb-2">Exercice</label>
                <select
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 max-w-md w-full">
              ...
              <div className="flex justify-end gap-2">
                <button onClick={cancelDeleteGoal} className="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold">Annuler</button>
        ...
        {showCongrats && (
          <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm" style={{ backgroundColor: 'rgba(0, 0, 0, 0.15)', backdropFilter: 'blur(8px)' }}>
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 flex flex-col items-center animate-avatar-pop" style={{ boxShadow: '0 0 32px 8px #a855f7, 0 0 0 #fff' }}>

        ...
        <div className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => router.back()}
                className="p-2 bg-white dark:bg-gray-900/20 rounded-lg hover:bg-white dark:bg-gray-900/30 transition-colors"
              >
                <ArrowLeft className="h-5 w-5" />
              </button>
              <div className="flex items-center space-x-3">
                <div className="bg-white dark:bg-gray-900/20 rounded-full p-3">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs mb-3">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 p-2 rounded text-center">
                        <div className="text-gray-600 dark:text-gray-700 font-medium">Progrès</div>

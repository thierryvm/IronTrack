    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow"
              >
                <div className="flex items-center mb-4">
                  {benefit.icon}
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 ml-3">{benefit.title}</h3>
                </div>
                <p className="text-gray-600 dark:text-gray-700 text-sm">{benefit.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        <motion.section
          ...
          className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 sm:p-8"
        >
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-700">Guide d'installation étape par étape</p>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {selectedGuide.steps.map((step) => (
                <div key={step.step} className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                  <button
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-orange-600 text-white rounded-full flex items-center justify-center text-sm font-semibold mr-4">
                        {step.step}
                      </div>
                      <div className="text-left">
                        <h5 className="font-semibold text-gray-900 dark:text-gray-100">{step.title}</h5>
                        <p className="text-gray-600 dark:text-gray-700 text-sm">{step.description}</p>
                      </div>
                    </div>
                  ...
                  {expandedStep === step.step && step.details && (
                    <motion.div
                      ...
                      className="p-4 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-600"
                    >
                        ...
                        <ul className="space-y-2 flex-1">
                          {step.details.map((detail, index) => (
                            <li key={index} className="text-gray-700 dark:text-gray-300 text-sm flex items-start">
                              <ArrowRight className="h-4 w-4 text-orange-800 dark:text-orange-300 mr-2 mt-0.5 flex-shrink-0" />
                              {detail}
                            </li>
                          ))}
                        </ul>
        ...
        >
          <div className="bg-gradient-to-r from-orange-600 to-red-500 dark:from-orange-500 dark:to-red-400 rounded-xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/"
                className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 dark:bg-orange-900/20 transition-colors inline-flex items-center justify-center"
              >

...
;
  ...
  useEffect(() => {
    ...
    // Gérer l'onglet activé via URL
    const tabParam = urlParams.get('tab');
    if (tabParam && ['profile', 'stats', 'settings'].includes(tabParam)) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-700">Chargement du profil...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-700">Profil non trouvé</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-2 mb-8 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-200"
        >
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center space-x-1 py-3 px-3 rounded-lg font-medium transition-colors min-w-[90px] md:min-w-[120px] text-xs md:text-base ${
                    activeTab === tab.id
                      ...
                      : 'text-gray-600 dark:text-gray-700 hover:bg-gray-100 dark:bg-gray-800'
                  }`}
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    <div className="relative">
                      ...
                      {showAvatarCongrats && (
                        <div className="absolute left-1/2 -bottom-10 -translate-x-1/2 bg-purple-600 text-white px-4 py-2 rounded-full shadow-lg text-sm font-bold animate-fade-in-out z-20 border-2 border-white dark:border-gray-700">
                          {avatarCongratsMsg}
                        </div>
                      )}
                      <Button
                        variant="secondary"
                        size="icon"
                        className="absolute -bottom-1 -right-1 bg-white dark:bg-gray-900 p-2 rounded-full shadow-md hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors min-h-touch-44 min-w-touch-44"
                        onClick={handleChangeAvatar}
                    ...
                    <div className="text-center">
                      <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">{profile.pseudo || profile.name || 'Utilisateur'}</h2>
                      <p className="text-gray-600 dark:text-gray-700 text-sm break-all">{profile.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 md:col-span-2">
                    ...
                    <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 text-center border border-orange-200 dark:border-orange-800">
                      <div className="text-sm text-orange-800 dark:text-orange-300 font-medium mb-1">Objectif</div>
            ...
            <div className="w-full lg:w-auto space-y-6">
              ...
              <Card className="flex flex-col gap-2">
                ...
                <div className="space-y-1 text-sm md:text-base">
                  <div className="flex justify-between"><span>Séries en cours</span><span className="text-orange-800 dark:text-orange-300 font-bold">{stats?.currentStreak || 0} jours</span></div>
        ...
        {activeTab === 'stats' && (
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg group relative">
                    <Trophy className="h-8 w-8 text-orange-800 dark:text-orange-300 mx-auto mb-2" />
                    <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats?.totalWorkouts || 0}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-700">Séances totales</p>
                  ...
                  <div className="text-center p-4 bg-blue-50 rounded-lg group relative">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-700">Jours consécutifs</p>
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-lg group relative">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-700">Séances/semaine</p>
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-lg group relative">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-700">Badges gagnés</p>
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                ...
                <div className="border-t pt-6">
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Exercice préféré</h4>
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <Dumbbell className="h-6 w-6 text-orange-800 dark:text-orange-300" />
                    <span className="font-medium text-gray-900 dark:text-gray-100">{stats?.favoriteExercise || 'Aucun exercice préféré'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Évolution du poids</h4>
                  <div className="space-y-2">
                    {progressionStats ? (
                      <>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-700">Début</span>
                          <span className="font-medium text-gray-900 dark:text-gray-100">
                            {progressionStats.initial_weight ? `${progressionStats.initial_weight} kg` : 'Non renseigné'}
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-700">Actuel</span>
                          <span className="font-medium text-orange-800 dark:text-orange-300">
                            {progressionStats.current_weight ? `${progressionStats.current_weight} kg` : 'Non renseigné'}
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-700">Évolution</span>
                          <span className={`font-medium ${progressionStats.weight_gain && progressionStats.weight_gain > 0 ? 'text-green-600' : progressionStats.weight_gain && progressionStats.weight_gain < 0 ? 'text-red-600' : 'text-gray-600 dark:text-gray-700'}`}>
                      ...
                      <>
                        {personalRecords.slice(0, 5).map((record, index) => (
                          <div key={index} className="flex justify-between text-sm">
                            <span className="text-gray-600 dark:text-gray-700">{record.exercise_name}</span>
                            <span className="font-medium text-gray-900 dark:text-gray-100">
                ...
                <div>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {achievements
                      ...
                      .map(achievement => (
                      <div key={achievement.id} className="text-center p-4 rounded-lg bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-700">{achievement.description}</p>
              ...
              <div className="space-y-6">
                {userBadges.length > 0 ? (
                      ...
                      <div key={badge.name} className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-4 border border-purple-200">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-700">{badge.description}</p>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-700 mt-2">Continue tes entraînements pour débloquer des badges !</p>
                  </div>
                )}
              </div>
            </div>
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center space-x-2">
                <Bell className="h-6 w-6 text-orange-800 dark:text-orange-300" />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-gray-100">Rappels d'entraînement</p>
                    <p className="text-sm text-gray-600 dark:text-gray-700">Recevoir des notifications pour tes séances</p>
                  </div>
                  <button
                    className={`w-12 h-6 rounded-full relative transition-colors ${notificationsEnabled ? 'bg-orange-600' : 'bg-gray-300'}`}
                    onClick={handleToggleNotifications}
                    aria-pressed={notificationsEnabled}
                    type="button"
                  >
                    <div className={`w-4 h-4 bg-white dark:bg-gray-900 rounded-full absolute top-1 transition-transform ${notificationsEnabled ? 'right-1' : 'left-1'}`}></div>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center space-x-2">
                <Settings className="h-6 w-6 text-orange-800 dark:text-orange-300" />
              ...
              className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-800 transition-colors flex items-center space-x-3 mb-2"
              aria-label="Modifier le mot de passe"
            >
                      <Settings className="h-5 w-5 text-gray-700" />
                      <div>
                        <p className="font-medium text-gray-900 dark:text-gray-100">Changer le mot de passe</p>
                        <p className="text-sm text-gray-600 dark:text-gray-700">Sécurise ton compte&nbsp;! (IronBuddy ne lit pas tes mots de passe, promis)</p>
                      </div>
                    </button>
                    <button 
                  ...
                  <div>
                    ...
                    <Button variant="outline" onClick={handleExportData} disabled={exporting} className="w-full justify-start p-4 h-auto min-h-touch-44" aria-label="Exporter mes données personnelles">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Télécharge ton historique (IronBuddy adore les stats&nbsp;!)</p>
                        {exporting && <span className="text-xs text-orange-800 dark:text-orange-300">Export en cours...</span>}
                  ...
                  <div>
                    ...
                    <Button variant="outline" onClick={handleChangeAvatar} className="w-full justify-start p-4 h-auto mb-2 hover:bg-purple-50 dark:hover:bg-purple-900/20 min-h-touch-44" aria-label="Modifier ma photo de profil">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">Un nouveau look pour de nouveaux PRs&nbsp;!</p>
                      </div>
                    </Button>
                    <button onClick={() => mascotSectionRef.current?.scrollIntoView({ behavior: 'smooth' })} className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-orange-50 dark:bg-orange-900/20 transition-colors flex items-center space-x-3 mb-2" aria-label="Accéder aux paramètres de la mascotte">
                      <Dumbbell className="h-5 w-5 text-orange-400" />
                      <div>
                        <p className="font-medium text-gray-900 dark:text-gray-100">Choisir ma mascotte</p>
                        <p className="text-sm text-gray-600 dark:text-gray-700">IronBuddy ou surprise du chef&nbsp;?</p>
                      </div>
                    </button>
                    <div className="mt-2">
                      <p className="text-sm text-gray-600 dark:text-gray-700 mb-1 font-medium">Niveau de punchlines d'IronBuddy</p>
                      <div className="flex gap-2">
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'discret' ? 'bg-gray-200 dark:bg-gray-700 border-orange-600' : 'bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600'}`}
                          onClick={() => handleIronBuddyLevelChange('discret')}
                        >Discret</button>
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'normal' ? 'bg-orange-100 border-orange-600' : 'bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600'}`}
                          onClick={() => handleIronBuddyLevelChange('normal')}
                        >Normal</button>
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'ambianceur' ? 'bg-orange-600 text-white border-orange-700' : 'bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600'}`}
                          onClick={() => handleIronBuddyLevelChange('ambianceur')}
                        >Ambianceur</button>
                      </div>
                      <p className="text-xs text-gray-600 mt-1">IronBuddy s'adapte à ton humeur&nbsp;!</p>
                    </div>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2 flex items-center space-x-2">
                    ...
                    <button onClick={handleSupport} className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-blue-50 transition-colors flex items-center space-x-3 mb-2" aria-label="Contacter le support client">
                      <HelpCircle className="h-5 w-5 text-blue-400" />
                      <div>
                        <p className="font-medium text-gray-900 dark:text-gray-100">Aide & support</p>
                        <p className="text-sm text-gray-600 dark:text-gray-700">Besoin d'un coup de main&nbsp;? IronBuddy est là&nbsp;!</p>
                      </div>
                    </button>
                    <button onClick={handleFAQ} className="w-full text-left p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-blue-50 transition-colors flex items-center space-x-3" aria-label="Consulter la foire aux questions">
                      <HelpCircle className="h-5 w-5 text-blue-400" />
                      <div>
                        <p className="font-medium text-gray-900 dark:text-gray-100">FAQ</p>
                        <p className="text-sm text-gray-600 dark:text-gray-700">Les questions que m'ême IronBuddy se pose parfois…</p>
                      </div>
                    </button>
                  </div>
                </div>
            ...
            {/* Mascotte IronBuddy */}
            <div ref={mascotSectionRef} className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center space-x-2">
                <Dumbbell className="h-6 w-6 text-orange-800 dark:text-orange-300" />
              ...
              <div className="space-y-4">
                ...
                <div className="mt-2 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                  <span className="font-bold text-orange-800 dark:text-orange-300">Choisir ma mascotte</span>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mt-3">
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'ironbuddy' ? 'border-orange-600 bg-orange-100' : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900'}`}
                      onClick={() => setSelectedMascot('ironbuddy')}
                    >
                      <Dumbbell className="h-6 w-6 sm:h-8 sm:w-8 text-orange-800 dark:text-orange-300 animate-bounce" />
                      <span className="mt-1 text-xs font-bold text-center">IronBuddy</span>
                    </button>
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'cat' ? 'border-orange-600 bg-orange-100' : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900'}`}
                    ...
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'bot' ? 'border-orange-600 bg-orange-100' : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900'}`}
                    ...
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'star' ? 'border-orange-600 bg-orange-100' : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900'}`}
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-700 mt-2">Ta mascotte te suivra partout dans l'app et t'encouragera à chaque étape !</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <Dialog open={showDeleteModal} onClose={() => setShowDeleteModal(false)} className="fixed z-50 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen px-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-8 max-w-md w-full z-10 relative">
            ...
            <DialogDescription className="mb-4 text-gray-700 dark:text-gray-300">Es-tu sûr de vouloir supprimer ton compte&nbsp;? <br/>IronBuddy va devoir faire du cardio pour s'en remettre…</DialogDescription>
            <div className="flex justify-end gap-2">
              <Button variant="secondary" onClick={() => setShowDeleteModal(false)} className="min-h-touch-44">Annuler</Button>
              <Button variant="destructive" onClick={confirmDeleteAccount} className="min-h-touch-44">Oui, supprimer</Button>
            </div>
          </div>
        </div>
      </Dialog>
      ...
      <Dialog open={showAvatarModal} onClose={() => { setShowAvatarModal(false); setSelectedFile(null); }} className="fixed z-50 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen px-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-8 max-w-md w-full z-10 relative">
            ...
            <DialogDescription className="mb-4 text-gray-700 dark:text-gray-300">Choisis une nouvelle photo de profil. IronBuddy validera le style !</DialogDescription>
            <div className="text-xs text-gray-600 mb-2">Ta photo ne sera utilisée que pour ton profil IronTrack. Elle n'est jamais partagée sans ton accord. (RGPD friendly !)</div>
            {selectedFile ? (
              <div className="flex flex-col items-center space-y-4">
                <div className="relative w-48 h-48 bg-gray-100 dark:bg-gray-800 rounded-lg">
                  <Cropper
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold"
              ...
              <form className="space-y-4" onSubmit={e => e.preventDefault()}>
                <label className="block">
                  <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Depuis la galerie ou fichiers</span>
                  <input
                    type="file"
                    accept="image/*,.heic,.heif"
                    onChange={handleAvatarFileChange}
                    disabled={avatarUploading}
                    className="block w-full text-sm text-gray-600 dark:text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100"
                  />
                </label>
                <label className="block">
                  <span className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Prendre une photo</span>
                  <input
                    type="file"
                    accept="image/*"
                    capture="environment"
            ...
            <div className="flex justify-end mt-4">
              <button onClick={() => { setShowAvatarModal(false); setSelectedFile(null); }} className="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold">Fermer</button>
            </div>
          </div>
        </div>
      </Dialog>
      ...
      <Dialog open={showMascotModal} onClose={() => setShowMascotModal(false)} className="fixed z-50 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen px-4">
          <div className="fixed inset-0 bg-black opacity-30" />
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-8 max-w-md w-full z-10 relative">
            <DialogTitle className="text-2xl font-bold text-orange-800 dark:text-orange-300 mb-2 flex items-center"><Dumbbell className="h-6 w-6 mr-2" /> Choisir ma mascotte</DialogTitle>
            <DialogDescription className="mb-4 text-gray-700 dark:text-gray-300">Fonctionnalité à venir&nbsp;! IronBuddy révise son plus beau sourire…</DialogDescription>
            <div className="flex justify-end">
              <button onClick={() => setShowMascotModal(false)} className="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-semibold">Fermer</button>
            </div>
          </div>
        </div>
      </Dialog>

          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">{workout.name}</h2>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="space-y-4">
              ...
              {workout.start_time && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-700">{workout.start_time}</span>
                </div>
              )}
              ...
              {workout.duration && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-700">{workout.duration} minutes</span>
                </div>
              )}
      ...
      <div className="bg-gradient-to-r from-orange-600 to-red-500 dark:from-orange-500 dark:to-red-400 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Link
              href="/workouts/new"
              className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 dark:bg-orange-900/20 transition-colors flex items-center space-x-2"
            >
              ...
              {workouts.map((workout, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-white dark:bg-gray-900 rounded-xl shadow-md hover:shadow-lg transition-all cursor-pointer border-l-4 ${
                      isCompleted ? 'border-green-500' : 'border-orange-600'
                    }`}

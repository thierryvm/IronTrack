...
const RecipeLibrary = dynamic(() => import('@/components/nutrition/RecipeLibrary'), {
  ssr: false,
  loading: () => <div className="animate-pulse bg-gray-100 dark:bg-gray-800 h-96 rounded-lg flex items-center justify-center">
    <span className="text-gray-600">Chargement de la bibliothèque...</span>
  </div>
})
...
const UnifiedMealModal = dynamic(() => import('@/components/nutrition/UnifiedMealModal'), {
  ...
  loading: () => <div className="animate-pulse bg-gray-100 dark:bg-gray-800 h-64 rounded-lg flex items-center justify-center">
    <span className="text-gray-600">Chargement du modal...</span>
  </div>
})
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-700">Chargement de la nutrition...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-0">
            ...
            <div className="flex items-center space-x-3">
              <button 
                ...
                className="bg-white dark:bg-gray-900/20 text-white px-6 py-3 rounded-lg font-semibold hover:bg-white dark:bg-gray-900/30 transition-colors flex items-center space-x-2 max-sm:px-3 max-sm:py-2 max-sm:text-sm"
              >
              ...
              <button 
                ...
                className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 dark:bg-orange-900/20 transition-colors flex items-center space-x-2 max-sm:px-3 max-sm:py-2 max-sm:text-sm"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border border-orange-100">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-700">/ {goals.calories} kcal</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border border-blue-100">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-700">/ {goals.protein}g</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border border-green-100">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-700">/ {goals.carbs}g</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border border-yellow-100">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-700">/ {goals.fat}g</p>
              </div>
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className="text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-1 focus:ring-2 focus:ring-orange-500 focus:border-orange-600"
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm text-gray-600 dark:text-gray-700">{todayMeals.length} repas enregistrés</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {mealTypes.map(mealType => (
              <div key={mealType.name} className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                {/* Header de la section */}
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 border-b border-gray-200 dark:border-gray-600">
                  ...
                  {todayMeals.filter(meal => meal.meal_type === mealType.name).length > 0 ? (
                    <div className="space-y-3">
                      {todayMeals.filter(meal => meal.meal_type === mealType.name).map((meal, index) => (
                        <div key={`${meal.id}-${index}`} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:bg-gray-800 transition-colors group">
                          <div className="flex-1">
                            <div className="font-medium text-gray-900 dark:text-gray-100">{meal.food_name}</div>
                            <div className="text-sm text-gray-600 dark:text-gray-700">{meal.time}</div>
                          </div>
                          <div className="flex items-center space-x-3">

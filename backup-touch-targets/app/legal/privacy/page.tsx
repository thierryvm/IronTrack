    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-600 via-red-500 to-purple-600 py-8 sm:py-12">
      <div className="max-w-4xl mx-auto px-4">
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8"
        >
          {/* Bouton de retour */}
          <button
            onClick={() => router.back()}
            className="flex items-center text-gray-600 dark:text-gray-700 hover:text-orange-800 dark:text-orange-300 transition-colors mb-6"
          >
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-700 mt-2 italic">
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-3 sm:p-4 rounded-lg">
                ...
                <div className="flex items-center space-x-2 text-sm">
                  <Mail className="h-4 w-4 text-orange-800 dark:text-orange-300" />

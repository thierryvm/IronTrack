...
export default function AdminDashboard() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case 'open':
        return <Clock className="h-4 w-4 text-orange-800 dark:text-orange-300" />
      case 'in_progress':
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-white dark:bg-gray-900 p-3 sm:p-6 rounded-xl shadow-sm animate-pulse min-h-[120px]">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 min-h-[200px] animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 min-h-[300px] animate-pulse">
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-700 truncate">
            Bonjour {user?.email.split('@')[0]} 👋
          </p>
        </div>
        
        <div className="mt-3 sm:mt-0 flex items-center justify-between sm:justify-end space-x-2 sm:space-x-3">
          <div className="flex items-center text-xs sm:text-sm text-gray-600 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-full">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center px-2 sm:px-3 py-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-800 transition-colors text-sm"
          >
        ...
        {[
          ...
          return (
            <div key={stat.title}>
              <Link href={stat.href}>
                <div 
                  className="bg-white dark:bg-gray-900 p-3 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700 cursor-pointer min-h-[120px]"
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-700 mb-1 truncate">
                      {stat.title}
                    </h3>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 min-h-[200px]" style={{ minHeight: '200px' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 min-h-[300px]" style={{ minHeight: '300px' }}>

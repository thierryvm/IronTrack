...
function AdminLayoutInternal({ children }: AdminLayoutProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-700">Vérification des permissions admin...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <div className="lg:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600 px-4 py-3 flex items-center justify-between header-mobile-ios">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 py-2 z-50"
              >
      ...
      <div className="flex">
        ...
        <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:bg-white dark:bg-gray-900 lg:border-r lg:border-gray-200 dark:border-gray-600">
          <div className="flex items-center h-16 flex-shrink-0 px-6 border-b border-gray-200 dark:border-gray-600">
        ...
        {sidebarOpen && (
          <>
            ...
            <div
              className="lg:hidden fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-600 z-50 flex flex-col"
            >
                <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-600">
                  <div className="flex items-center space-x-2">
                    <Shield className="h-6 w-6 text-orange-800 dark:text-orange-300" />
                    <span className="font-bold text-gray-900 dark:text-gray-100">IronTrack Admin</span>
                  </div>

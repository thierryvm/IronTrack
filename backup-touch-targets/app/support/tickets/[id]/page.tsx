...
export default function TicketDetailPage() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default:
        return <MessageCircle className="h-5 w-5 text-gray-700" />
    }
  }
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'closed': return 'bg-gray-100 dark:bg-gray-800 text-gray-800 border-gray-300'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-800">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 dark:text-gray-700">Catégorie:</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 dark:text-gray-700">Priorité:</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 dark:text-gray-700">Créé:</span>
              <span className="font-medium">{formatDate(ticket.created_at)}</span>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="h-4 w-4 text-blue-500" />
              <span className="text-gray-600 dark:text-gray-700">Réponses:</span>

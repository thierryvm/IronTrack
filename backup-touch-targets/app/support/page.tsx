        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-700">Guides et documentation pour utiliser IronTrack</p>
            </div>
          </div>
        </div>
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-700">Envoyez des invitations à vos amis</p>
                        </div>
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          <Users className="h-8 w-8 text-blue-500 mx-auto mb-2" />
                          <h4 className="font-medium text-gray-900 dark:text-gray-100">Partager</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-700">Partagez vos séances d'entraînement</p>
                        </div>
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-700">Gérez vos paramètres de partage</p>
                        </div>
                      </div>
                    </section>
                        ...
                        <div className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-700">
                                <li>• <Settings className="h-3 w-3 inline text-gray-600" /> Paramètres de partage</li>
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-700">Définissez vos challenges</p>
                        </div>
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          <TrendingUp className="h-8 w-8 text-blue-500 mx-auto mb-2" />
                          <h4 className="font-medium text-gray-900 dark:text-gray-100">Performances</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-700">Suivez vos résultats</p>
                        </div>
                        <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                          <Award className="h-8 w-8 text-yellow-500 mx-auto mb-2" />
                          <h4 className="font-medium text-gray-900 dark:text-gray-100">Badges</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-700">Débloquez des récompenses</p>
                        </div>
                      </div>
                    </section>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-700">Prise de masse, Perte de poids, Maintien, ou Performance</p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-700">Débutant, Intermédiaire, ou Avancé</p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-700">Faible, Modérée, ou Élevée + disponibilité par séance</p>
                          </div>
                        </div>
                        <div className="flex items-start space-x-3">
                          <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-700">Taille, poids actuel, âge, et poids initial</p>
                          </div>
                        </div>
                      </div>
                    </section>
        ...
        <div className="mt-8 bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            >
              ...
              <ArrowRight className="h-4 w-4 text-orange-800 dark:text-orange-300 group-hover:text-orange-800 dark:text-orange-300" />
            </Link>
            <Link 
              href="/training-partners" 
              className="flex items-center space-x-3 p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-orange-50 dark:bg-orange-900/20 hover:border-orange-200 dark:border-orange-800 transition-colors group"
            >
              <Users className="h-6 w-6 text-orange-800 dark:text-orange-300" />
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-gray-100">Training Partners</p>
                <p className="text-sm text-gray-600 dark:text-gray-700">Gérer vos partenaires</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-700 group-hover:text-orange-800 dark:text-orange-300" />
            </Link>
            
            <Link 
              href="/faq" 
              className="flex items-center space-x-3 p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-blue-50 hover:border-blue-200 transition-colors group"
            >
              <HelpCircle className="h-6 w-6 text-blue-500" />
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-gray-100">FAQ</p>
                <p className="text-sm text-gray-600 dark:text-gray-700">Questions fréquentes</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-700 group-hover:text-blue-500" />
            </Link>

            <Link 
              href="/progress" 
              className="flex items-center space-x-3 p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-purple-50 hover:border-purple-200 transition-colors group"
            >
              <TrendingUp className="h-6 w-6 text-purple-500" />
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-gray-100">Progression</p>
                <p className="text-sm text-gray-600 dark:text-gray-700">Objectifs & badges</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-700 group-hover:text-purple-500" />
            </Link>

            <Link 
              href="/profile" 
              className="flex items-center space-x-3 p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-green-50 hover:border-green-200 transition-colors group"
            >
              <Settings className="h-6 w-6 text-green-500" />
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-gray-100">Paramètres</p>
                <p className="text-sm text-gray-600 dark:text-gray-700">Gérer votre profil</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-700 group-hover:text-green-500" />
            </Link>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-700">Refaire la configuration</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-700 group-hover:text-orange-800 dark:text-orange-300" />
            </Link>
          </div>

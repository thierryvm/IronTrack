...
function ContactSupportPageContent() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'in_progress':
        return <AlertCircle className="h-4 w-4 text-orange-800 dark:text-orange-300" />
      case 'resolved':
      case 'closed':
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              >
                <ArrowLeft className="h-5 w-5 text-gray-600 dark:text-gray-700" />
              </Link>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
                ...
                {loadingTickets ? (
                  <div className="flex items-center justify-center py-8">
                    ...
                    <span className="text-gray-600 dark:text-gray-700">Chargement de vos tickets...</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    {userTickets.map((ticket) => (
                      <div key={ticket.id} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-700 text-sm line-clamp-2">{ticket.description}</p>
                      </div>
                    ))}
                  </div>
                )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-700">🐛 Bugs critiques</span>
                  <span className="text-sm font-medium text-red-600">&lt; 2h</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-700">👤 Problèmes de compte</span>
                  <span className="text-sm font-medium text-orange-800 dark:text-orange-300">&lt; 4h</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-700">❓ Aide générale</span>
                  <span className="text-sm font-medium text-blue-600">&lt; 24h</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-700">💡 Nouvelles fonctionnalités</span>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <Link 
                  href="/faq"
                  className="block p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-gray-800 transition-colors"
                >
                  <p className="font-medium text-gray-900 dark:text-gray-100 mb-1">Questions Fréquentes</p>
                  <p className="text-xs text-gray-600 dark:text-gray-700">Réponses aux questions courantes</p>
                </Link>
                ...
                >
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-700">Documentation complète</p>
                </Link>
              </div>
            </div>
          </div>
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-700">Chargement...</p>
        </div>
      </div>
    }>

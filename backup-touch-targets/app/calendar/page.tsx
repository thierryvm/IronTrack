    ...
    <>
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button
                ...
                className="lg:hidden bg-white dark:bg-gray-900/10 text-white/90 hover:bg-white dark:bg-gray-900/20 px-3 py-3 rounded-lg transition-colors flex items-center space-x-2 min-h-[44px] touch-manipulation"
              ...
              <button
                ...
                className="xl:hidden bg-white dark:bg-gray-900/10 text-white/90 hover:bg-white dark:bg-gray-900/20 px-3 py-3 rounded-lg transition-colors flex items-center space-x-2 min-h-[44px] touch-manipulation"
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-3 rounded-lg transition-colors flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base min-h-[44px] touch-manipulation ${
                  showPartnersWorkouts 
                    ? 'bg-white dark:bg-gray-900/20 text-white border border-white dark:border-gray-700/30' 
                    : 'bg-white dark:bg-gray-900/10 text-white/90 hover:bg-white dark:bg-gray-900/20'
                }`}
                title={
              ...
              >
                ...
                {partnersWorkouts.length > 0 ? (
                  <span className="bg-white dark:bg-gray-900/20 text-white rounded-full px-2 py-0.5 text-xs">
                    {partnersWorkouts.length}
                  </span>
                ) : (
                  <span className="bg-white dark:bg-gray-900/20 text-white rounded-full px-2 py-0.5 text-xs font-bold">
                    0
                  </span>
                )}
              </button>
              <button
                ...
                className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-3 sm:px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 dark:bg-orange-900/20 transition-colors flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base min-h-[44px] touch-manipulation"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 lg:gap-8">
          ...
          >
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-3 sm:p-6">
              {viewMode === 'calendar' ? (
                <>
                  ...
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <motion.button
                      ...
                      className="p-3 hover:bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors touch-manipulation"
                      whileTap={{ scale: 0.95 }}
                    ...
                    <div className="flex items-center gap-2">
                      <motion.button
                        ...
                        className="px-3 py-2 bg-gradient-to-r from-orange-600 to-red-500 dark:from-orange-500 dark:to-red-400 text-white rounded-lg text-sm font-semibold shadow-md hover:shadow-lg transition-all touch-manipulation"
                        whileTap={{ scale: 0.95 }}
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {(() => {
                      ...
                      return monthWorkouts.map(workout => {
                        ...
                        return (
                          <div key={workout.id} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border-l-4 border-orange-600">
          ...
          >
            {/* Date sélectionnée */}
            {selectedDate && (
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-4 lg:p-6">
                    ...
                    if (sessions.length === 0) {
                      return (
                        <div className="text-center py-6 text-gray-600">
                          <CalendarIcon className="h-8 w-8 mx-auto mb-2 text-gray-700" />
                    ...
                    return sessions.map(item => (
                      <div key={item.id} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg flex flex-col gap-1">
                        ...
                        {item.participants && item.participants.length > 0 && item.participants[0] && (
                          <span className="ml-2 text-xs text-gray-600 flex items-center gap-1">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md p-4 lg:p-6">
              ...
              <div className="space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div className="group relative">
                    <Info className="h-3 w-3 text-gray-700 cursor-help" />
                ...
                {workoutTypes.map(type => {
                  ...
                  return (
                    <div key={type.name} className="flex items-center space-x-2">
                      ...
                      <Icon className="h-4 w-4 text-gray-600 dark:text-gray-700" />
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-700">{type.name}</span>
                    </div>
                  )
                })}
              </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    {(() => {
                      ...
                      return sessions.map(item => (
                        <div key={item.id} className="p-3 bg-white dark:bg-gray-900 rounded-lg border flex flex-col gap-1">
                          <div className="flex items-center justify-between mb-1">
                            <h4 className="font-medium text-gray-900 dark:text-gray-100 flex items-center gap-2">
                              {item.name}
                              {item.isShared && <span className="inline-flex items-center px-2 py-0.5 rounded bg-blue-100 text-blue-700 text-xs font-semibold ml-2">👥 Partagée</span>}
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-medium text-white ${getTypeColor(item.type)}`}>{item.type}</span>
                          {item.duration && (
                            <span className="flex items-center space-x-1 text-sm text-gray-600 dark:text-gray-700">
                              <Clock className="h-3 w-3" />
                              <span>{item.duration} min</span>
                            </span>
                          )}
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="bg-white dark:bg-gray-900 p-3 rounded border">
                      <span className="text-xs text-gray-600 block">Total séances</span>
                      <span className="font-bold text-gray-900 dark:text-gray-100 text-lg">{totalSeances}</span>
                    </div>
                    <div className="bg-white dark:bg-gray-900 p-3 rounded border">
                      <span className="text-xs text-gray-600 block">Durée moyenne</span>
                      <span className="font-bold text-gray-900 dark:text-gray-100 text-lg">{moyenneDuree} min</span>
                    </div>
                  </div>
                  
                  {maxDuree > 0 && seanceMax && (
                    <div className="bg-white dark:bg-gray-900 p-3 rounded border mb-2">
                      <span className="text-xs text-gray-600 block">Séance la plus longue</span>
                  ...
                  {minDuree > 0 && seanceMin && (
                    <div className="bg-white dark:bg-gray-900 p-3 rounded border mb-3">
                      <span className="text-xs text-gray-600 block">Séance la plus courte</span>
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {repartitionTypes.filter(type => type.count > 0).map(type => {
                      ...
                      const Icon = typeObj?.icon
                      return (
                        <div key={type.name} className="flex items-center gap-2 p-2 bg-white dark:bg-gray-900 rounded border">
                          {Icon && <Icon className="h-4 w-4 text-gray-600 dark:text-gray-700" />}

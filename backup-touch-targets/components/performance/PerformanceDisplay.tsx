    ...
    >
      ...
      {(variant === 'card' || variant === 'detailed') && (
        <div className="flex items-center space-x-2 text-sm mb-2">
          {showIcon && <TrendingUp className="h-4 w-4 text-orange-800 dark:text-orange-300 flex-shrink-0" />}
          <span className="text-gray-600 dark:text-gray-700 font-medium">
      ...
      {(variant === 'card' || variant === 'detailed') && (
        <div className="mt-3 space-y-2">
          ...
          {performance.notes && variant === 'detailed' && (
            <div className="mt-2 p-2 bg-gray-50 dark:bg-gray-800 rounded text-xs text-gray-600 dark:text-gray-700">

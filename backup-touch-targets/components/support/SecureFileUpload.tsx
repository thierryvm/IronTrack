      ...
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-center">
            <Upload className={`h-12 w-12 ${isDragging ? 'text-orange-800 dark:text-orange-300' : 'text-gray-700'}`} />
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    <Image className="h-4 w-4 text-gray-600" aria-label="Icône fichier" />
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="text-gray-700 hover:text-gray-600 dark:text-gray-700 p-1"

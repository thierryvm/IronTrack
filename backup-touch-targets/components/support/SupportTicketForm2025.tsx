...
export const SupportTicketForm2025: React.FC<SupportTicketForm2025Props> = ({
  ...
  const getCategoryStyle = (category: SupportTicketCategory, isSelected: boolean) => {
    ...
    return 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:bg-gray-800'
  }
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-50 to-red-50 border-b border-gray-200 dark:border-gray-600 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-700">Sélectionnez la catégorie qui correspond le mieux à votre demande</p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="text-gray-600">{title.length}/200 caractères</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="text-gray-600">{description.length} caractères - Plus vous donnez d'informations, plus nous pourrons vous aider efficacement</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-700">Ajoutez des captures d'écran pour nous aider à mieux comprendre votre problème (optionnel)</p>
                  ...
                  <div className="space-y-2">
                    {attachments.map((attachment) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -10 }}
                        className="flex items-center justify-between bg-gray-50 dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600"
                      >
                        <div className="flex items-center space-x-3">

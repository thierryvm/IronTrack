...
export function EmailChangeModal({ isOpen, onClose, currentEmail }: EmailChangeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-700">Processus sécurisé</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        {step === 'form' && (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="p-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-600 dark:text-gray-700">
                {currentEmail}
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="button"
                onClick={handleClose}
                className="flex-1 px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 rounded-lg font-medium transition-colors"
              >
                Annuler
              </button>
              <button
        ...
        {step === 'verification' && (
          <div className="text-center space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={handleClose}
                className="px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 rounded-lg font-medium transition-colors"
              >
                Fermer
              </button>
            </div>

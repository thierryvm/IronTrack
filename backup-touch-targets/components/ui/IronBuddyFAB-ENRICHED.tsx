          ...
          <>
            ...
            <motion.div
              ...
              className="
                ...
                bg-white dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl 
                border border-gray-200 dark:border-gray-600/50 overflow-hidden
            ...
            >
              ...
              <div className={`${mascot.bgColor} px-6 py-4 text-white relative overflow-hidden`}>
                ...
                <div className="flex items-center space-x-3 relative z-10">
                  <motion.div
                    ...
                    className="bg-white dark:bg-gray-900/20 rounded-full p-2"
                  >
              ...
              {/* Sélecteur de mode */}
              <div className="px-6 py-3 bg-gray-50 dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-600/50">
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all ${
                      !showMascotMode 
                        ...
                        : 'bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-700 hover:bg-gray-100 dark:bg-gray-800'
                    }`}
                  >
                ...
                <AnimatePresence mode="wait">
                  {showMascotMode ? (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs text-gray-600 dark:text-gray-700 mb-2 font-medium">Changer de coach :</p>
                        <div className="flex space-x-2">
                      ...
                      <div className="border-t border-gray-100 dark:border-gray-700 pt-2 mt-3">
                        <div className="grid grid-cols-2 gap-2">
                          <Link
                            href="/faq"
                            onClick={() => setIsOpen(false)}
                            className="flex items-center justify-center px-3 py-2 text-xs text-gray-600 dark:text-gray-700 hover:text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:bg-gray-800 rounded-lg transition-colors"
                          >
                            📚 FAQ
                          </Link>
                          <Link
              ...
              {/* Footer */}
              <div className="px-6 py-3 bg-green-50/80 border-t border-gray-200 dark:border-gray-600/50">
                <div className="flex items-center space-x-2">

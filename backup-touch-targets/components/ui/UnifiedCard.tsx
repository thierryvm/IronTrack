      ...
      {actions.length > 0 && (
        <div className="absolute top-4 right-4 z-20">
          <button
            ...
            className="p-2 rounded-full text-gray-700 hover:text-gray-600 dark:text-gray-700 hover:bg-gray-100 dark:bg-gray-800 transition-colors"
            aria-label="Actions"
          ...
          {isDropdownOpen && (
            <div
              ref={dropdownRef}
              className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600 py-1 z-50"
    ...
    <div className={`flex items-start justify-between mb-3 ${className}`}>
      <div className="flex items-start space-x-3 flex-1">
        ...
        <div className="min-w-0 flex-1">
          ...
          {subtitle && (
            <p className="text-sm text-gray-600 dark:text-gray-700 mt-1">{subtitle}</p>
          )}
        </div>
      </div>

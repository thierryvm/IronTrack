    ...
    <>
      ...
      <div className="fixed top-4 left-4 z-50 flex flex-col space-y-2">
        ...
        <motion.button
          ...
          className="p-3 bg-white dark:bg-gray-900 rounded-full shadow-lg hover:bg-gray-50 dark:bg-gray-800 transition-colors border border-gray-200 dark:border-gray-600"
          title={soundEnabled ? 'Désactiver les sons' : 'Activer les sons'}
        >
          {soundEnabled ? (
            <Volume2 className="h-5 w-5 text-gray-600 dark:text-gray-700" />
          ) : (
            <VolumeX className="h-5 w-5 text-gray-600 dark:text-gray-700" />
          )}
        </motion.button>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 mt-0.5 bg-white dark:bg-gray-900/20 p-2 rounded-lg">
              ...
              <motion.div
                ...
                className="h-0.5 bg-white dark:bg-gray-900/30 rounded-full mt-3"
              />
            </motion.div>
          ))}
        </AnimatePresence>

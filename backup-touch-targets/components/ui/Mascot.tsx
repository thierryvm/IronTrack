        ...
        >
          ...
          >
            ...
            <div className="flex gap-2 mb-2 max-sm:gap-1">
              <button onClick={handleJoke} className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-2 py-1 rounded hover:bg-orange-100 text-xs font-bold max-sm:px-1 max-sm:py-0.5 max-sm:text-[11px]">Blague</button>
              <button onClick={handleAdvice} className="bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 px-2 py-1 rounded hover:bg-orange-100 text-xs font-bold max-sm:px-1 max-sm:py-0.5 max-sm:text-[11px]">Conseil</button>
            </div>
    ...
    <ClientOnly>
      {minimized ? (
        <div className="fixed bottom-20 right-4 z-[60] cursor-pointer md:bottom-4" onClick={handleRestore} title="Afficher la mascotte">
          <div className="bg-white dark:bg-gray-900 rounded-full shadow-2xl p-3 flex items-center justify-center border-2 border-orange-400 hover:scale-110 transition-transform">

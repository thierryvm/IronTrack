    ...
    <div className={`space-y-4 ${className}`}>
      ...
      {currentPhoto ? (
        <div className="relative group">
          <div className="relative w-full h-48 sm:h-56 md:h-64 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800">
            <Image
              src={currentPhoto}
                ...
                {isMobile ? (
                  <>
                    ...
                    <button
                      ...
                      className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-3 py-3 rounded-md text-sm font-medium hover:bg-gray-50 dark:bg-gray-800 flex items-center min-h-[44px] touch-manipulation"
                      disabled={disabled || uploadState.isUploading}
                    >
                  ...
                  <button
                    onClick={openFileDialog}
                    className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-4 py-3 rounded-md text-sm font-medium hover:bg-gray-50 dark:bg-gray-800 flex items-center min-h-[44px] touch-manipulation"
                    disabled={disabled || uploadState.isUploading}
                  >
                    <Camera className="h-4 w-4 mr-2" />
                    Changer
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-center">
              {uploadState.isUploading ? (
                ...
                <Camera className={`h-16 w-16 sm:h-12 sm:w-12 ${isDragging ? 'text-orange-800 dark:text-orange-300' : 'text-gray-700'}`} />
              )}
            </div>
            ...
            <div>
              {uploadState.isUploading ? (
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-700">{uploadState.progress.toFixed(0)}%</p>
                </div>
              ) : (
                <>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-700 mb-3">
                    {isMobile 

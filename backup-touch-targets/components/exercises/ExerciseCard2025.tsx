...
export function ExerciseCard2025({
  ...
  const getCardClasses = () => {
    const base = 'bg-white dark:bg-gray-900 rounded-xl shadow-md hover:shadow-lg border border-gray-100 dark:border-gray-700 hover:border-orange-200 dark:border-orange-800 transition-all duration-300 overflow-hidden group flex flex-col min-h-[500px]'
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-600">
            ...
            {!exercise.muscle_group && !exercise.equipment && (
              <span className="text-gray-700 italic">Métadonnées à compléter</span>
            )}
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg flex-1">
          <div className="flex items-center space-x-2 text-sm mb-2">
            <TrendingUp className="h-4 w-4 text-orange-800 dark:text-orange-300 flex-shrink-0" />
            <span className="text-gray-600 dark:text-gray-700 font-medium">Dernière performance</span>
          </div>
        ...
        <div className="flex items-center space-x-3 mt-auto">
          ...
          <button
            ...
            className="px-4 py-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 
          ...
          {onDelete && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="p-3 text-gray-700 hover:text-red-500 hover:bg-red-50 

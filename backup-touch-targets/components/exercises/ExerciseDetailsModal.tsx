    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-hidden shadow-2xl"
        >
          {/* Header */}
          <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600 px-6 py-4 flex items-center justify-between">
            <button
              onClick={onClose}
              ...
              <div className="space-y-6">
                  ...
                  <div className="mt-4 space-y-3">
                    {exercise.description ? (
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-700">{exercise.description}</p>
                      </div>
                    ) : (
                    ...
                    {exercise.instructions ? (
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-700 text-sm whitespace-pre-line">{exercise.instructions}</p>
                      </div>
                    ) : (
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 py-3 px-4 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                  >
                  ...
                  {performances.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {performances.map((perf) => (
                        <div
                          key={perf.id}
                          className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-sm transition-shadow"
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              {perf.notes && (
                                <p className="text-sm text-gray-600 dark:text-gray-700 mt-1">{perf.notes}</p>
                              )}
                            </div>

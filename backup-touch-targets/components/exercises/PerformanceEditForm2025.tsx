    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-700 mb-4">La performance demandée n'existe pas ou a été supprimée.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      ...
      <motion.div
        ...
        className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600 sticky top-0 z-10"
      >

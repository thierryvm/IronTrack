...
export const ExerciseEditForm2025: React.FC<ExerciseEditForm2025Props> = ({ exerciseId }) => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-700 mb-4">L'exercice demandé n'existe pas ou a été supprimé.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-800">
      {/* Header */}
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600 sticky top-0 z-10">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Button
                ...
                className="text-gray-700 hover:text-gray-600 dark:text-gray-700"
              >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              {exercise && (
                <div className="border-t border-gray-200 dark:border-gray-600 pt-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-700 mb-6">
          ...
          <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-600 px-6 py-4 shadow-lg">

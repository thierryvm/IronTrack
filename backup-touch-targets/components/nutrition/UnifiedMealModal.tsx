    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative bg-white dark:bg-gray-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden"
        ...
        >
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-600">
            ...
            <div className="flex space-x-1 mt-4 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg">
              <button
                onClick={() => setAddMode('smart')}
                className={`flex-1 py-2 px-3 rounded-md text-sm font-medium transition-colors ${
                  addMode === 'smart' 
                    ? 'bg-white dark:bg-gray-900 text-orange-800 dark:text-orange-300 shadow-sm' 
                    : 'text-gray-600 dark:text-gray-700 hover:text-gray-900 dark:text-gray-100'
                }`}
              >

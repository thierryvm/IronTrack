    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-4">
            <div className="text-center mb-6">
              <ChefHat className="h-12 w-12 mx-auto text-orange-800 dark:text-orange-300 mb-2" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Sélectionnez vos ingrédients</h3>
              <p className="text-gray-600 dark:text-gray-700">Recherchez et ajoutez les ingrédients de votre repas</p>
            </div>
            ...
            {ingredients.length > 0 && (
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900 dark:text-gray-100">Ingrédients sélectionnés ({ingredients.length})</h4>
                {ingredients.map((ingredient) => (
                  <div key={ingredient.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center">
                        <span className="text-orange-800 dark:text-orange-300 font-bold text-sm">
      ...
      case 2:
        return (
          <div className="space-y-4">
            <div className="text-center mb-6">
              <Scale className="h-12 w-12 mx-auto text-orange-800 dark:text-orange-300 mb-2" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Définissez les quantités</h3>
              <p className="text-gray-600 dark:text-gray-700">Ajustez les quantités pour chaque ingrédient</p>
            </div>
            ...
            <div className="space-y-4">
              {ingredients.map((ingredient) => {
                ...
                return (
                  <div key={ingredient.id} className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg space-y-3">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                      <div className="grid grid-cols-4 gap-2 text-sm">
                        <div className="text-center">
                          ...
                          <p className="text-gray-600 dark:text-gray-700">cal</p>
                        </div>
                        <div className="text-center">
                          <span className="font-medium text-blue-600">
                            {ingredient.calculatedNutrition.protein}g
                          </span>
                          <p className="text-gray-600 dark:text-gray-700">prot</p>
                        </div>
                        <div className="text-center">
                          <span className="font-medium text-green-600">
                            {ingredient.calculatedNutrition.carbs}g
                          </span>
                          <p className="text-gray-600 dark:text-gray-700">glu</p>
                        </div>
                        <div className="text-center">
                          <span className="font-medium text-yellow-600">
                            {ingredient.calculatedNutrition.fat}g
                          </span>
                          <p className="text-gray-600 dark:text-gray-700">lip</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <Calculator className="h-12 w-12 mx-auto text-orange-800 dark:text-orange-300 mb-2" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Résumé et sauvegarde</h3>
              <p className="text-gray-600 dark:text-gray-700">Nommez votre repas et vérifiez les valeurs nutritionnelles</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-700">calories</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-700">protéines</div>
                  <div className="text-xs text-gray-600">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-700">glucides</div>
                  <div className="text-xs text-gray-600">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-700">lipides</div>
                  <div className="text-xs text-gray-600">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Détail des ingrédients</h4>
              <div className="space-y-2">
                {ingredients.map((ingredient) => (
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                step === currentStep 
                  ...
                  : step < currentStep 
                    ...
                    : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-700'
              }`}>
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors ${
              currentStep === 1 
                ? 'bg-gray-100 dark:bg-gray-800 text-gray-700 cursor-not-allowed' 
            ...
            <div className="flex space-x-3">
              {onSaveAsRecipe && (
                ...
                >
                  {isSavingRecipe ? (
                    <>
                      <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white dark:border-gray-700"></div>

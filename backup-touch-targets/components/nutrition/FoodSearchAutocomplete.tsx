    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        {query && (
          <button
            onClick={clearSearch}
            className="absolute inset-y-0 right-0 pr-3 flex items-center hover:text-gray-600 dark:text-gray-700"
          >
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute z-20 w-full mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg max-h-96 overflow-y-auto">
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-shrink-0 w-12 h-12 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden">
                    ...
                    <Package className={`h-6 w-6 text-gray-700 ${food.image_url ? 'hidden' : ''}`} />
                  </div>
      ...
      {isOpen && !isLoading && results.length === 0 && query.length >= 2 && (
        <div className="absolute z-20 w-full mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg p-4 text-center text-gray-600">

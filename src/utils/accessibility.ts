...
export const contrastClasses = {
 highContrast:"text-foreground bg-card border-border",
 focusVisible:"focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary",
...
export function hasGoodContrast(bgColor: string, textColor: string): boolean {
 ...
 const darkBgs = ['bg-gray-900','bg-black','bg-primary','bg-red-500']

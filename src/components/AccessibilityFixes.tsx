...
function useAccessibilityFixes() {
 ...
 .text-gray-600 dark:not([class*="menu"]):not([class*="nav"]):not([class*="header"]) { 
 color: #6b7280 !important; 
}
 .text-gray-700 dark:not([class*="menu"]):not([class*="nav"]):not([class*="header"]) { 
 color: #4b5563 !important; 
}
 
 /* Links navigation préservés - SEULEMENT contenu principal */
 main a:not(.btn-primary):not(.bg-primary):not([class*="text-"]) {

...
'relative h-6 cursor-pointer group',
 ...
 ref={thumbRef}
 className={cn(
'absolute top-1/2 -translate-y-1/2 w-6 h-6 bg-card border-2 border-primary rounded-full shadow-lg cursor-grab',
'transition-all duration-200 hover:scale-110 active:cursor-grabbing',
 ...
 exit={{ opacity: 0, y: 10}}
 className="absolute -top-12 bg-gray-900 text-white px-2 py-1 rounded-lg text-sm font-medium shadow-lg pointer-events-none"

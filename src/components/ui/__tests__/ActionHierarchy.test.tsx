...
describe('ActionHierarchy', () => {
  ...
  describe('Rendu de base', () => {
    ...
    it('applique les bonnes classes selon le type d\'action', () => {
      ...
      expect(secondaryBtn).toHaveClass('bg-gray-100 dark:bg-gray-800', 'text-gray-700 dark:text-gray-300')

      // Action tertiaire minimaliste
      const tertiaryBtn = screen.getByTestId('edit-action')
      expect(tertiaryBtn).toHaveClass('text-gray-600', 'dark:text-gray-300', 'hover:bg-gray-50')
    })
...
describe('useStandardActions', () => {
  ...
  it('crée les actions standards avec les bonnes configurations', () => {
    ...
    expect(screen.getByText('Détails').closest('button')).toHaveClass('bg-gray-100 dark:bg-gray-800')

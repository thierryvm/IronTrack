...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
 ...
 onClick={onConfirm}
 disabled={loading}
 className={`flex-1 ${styles.confirmBg} ${styles.confirmText} py-2 px-4 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50`}
 >
 {loading ? (

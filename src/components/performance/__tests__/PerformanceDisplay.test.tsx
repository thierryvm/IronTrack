...
describe('PerformanceDisplay', () => {
  ...
  describe('Variantes d\'affichage', () => {
    it('applique les styles de variante inline (défaut)', () => {
      ...
      expect(container).not.toHaveClass('bg-gray-50', 'p-4') // Pas de styles card
    })
    ...
    it('applique les styles de variante card', () => {
      ...
      expect(container).toHaveClass('bg-gray-50', 'rounded-lg', 'p-4')
    ...
    it('applique les styles de variante detailed', () => {
      ...
      expect(container).toHaveClass('bg-white', 'rounded-lg', 'p-6', 'shadow-sm')
  ...
  describe('Cas limites', () => {
    it('affiche message par défaut pour performance vide', () => {
      ...
      expect(container).toHaveClass('text-gray-600 dark:text-safe-muted', 'italic')
    })

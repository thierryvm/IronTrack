...
export const AdminTicketsPage = dynamic(
 ...
 <div className="bg-card border border-border rounded-xl p-6 shadow-md animate-pulse">
...
export const AdminExportsPage = dynamic(
 ...
 <div key={i} className="bg-card border border-border rounded-xl p-6 shadow-md animate-pulse">

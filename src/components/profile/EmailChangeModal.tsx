...
export function EmailChangeModal({ isOpen, onClose, currentEmail}: EmailChangeModalProps) {
 ...
 <p className="text-sm text-muted-foreground">Processus sécurisé</p>
 </div>
 </div>
 <button
 onClick={handleClose}
 ...
 <div className="p-2 bg-muted border border-border rounded-lg text-sm text-muted-foreground">
 {currentEmail}
 </div>
 </div>
 ...
 className="w-full px-2 py-2 border border-border rounded-lg focus:ring-2 focus:ring-secondary focus:border-secondary"
 ...
 type="button"
 onClick={handleClose}
 className="flex-1 px-4 py-2 text-foreground bg-muted hover:bg-muted rounded-lg font-medium transition-colors"
 >
 Annuler
 </button>
 <button
 type="submit"
 disabled={loading}
 className="flex-1 px-4 py-2 bg-secondary hover:bg-secondary-hover text-white rounded-lg font-medium transition-colors disabled:opacity-50"
 >
 ...
 <button
 onClick={handleClose}
 className="px-4 py-2 text-foreground bg-muted hover:bg-muted rounded-lg font-medium transition-colors"
 >
 Fermer
 </button>
 </div>

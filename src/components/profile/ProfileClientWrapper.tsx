                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    <div className="relative">
                      ...
                      {showAvatarCongrats && (
                        <div className="absolute left-1/2 -bottom-10 -translate-x-1/2 bg-purple-600 text-white px-4 py-2 rounded-full shadow-lg text-sm font-bold animate-fade-in-out z-20 border-2 border-white dark:border-border">
                          {avatarCongratsMsg}
                        </div>
                      )}
                      <Button
          ...
          >
            ...
            <div className="bg-card border border-border  rounded-xl shadow-md p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-t pt-6">
                  <h4 className="font-semibold text-foreground mb-3">Exercice préféré</h4>
            ...
            <div className="bg-card border border-border  rounded-xl shadow-md p-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold text-foreground mb-3">Records personnels</h4>
                  <div className="space-y-2">
                    {progressionLoading ? (
        ...
        {activeTab === 'settings' && (
          ...
          >
            ...
            <div className="bg-card border border-border  rounded-xl shadow-md p-6">
              ...
              className="w-full text-left p-4 border border-border rounded-lg hover:bg-muted transition-colors flex items-center space-x-3 mb-2"
            ...
            >
                    ...
                    <button 
                      ...
                      className="w-full text-left p-4 border border-destructive/40 rounded-lg hover:bg-destructive/10 transition-colors flex items-center space-x-3 mb-2 focus:outline-none focus:ring-2 focus:ring-destructive"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <button onClick={() => mascotSectionRef.current?.scrollIntoView({ behavior: 'smooth' })} className="w-full text-left p-4 border border-border rounded-lg hover:bg-blue-50 dark:bg-blue-900/10 transition-colors flex items-center space-x-3 mb-2" aria-label="Accéder aux paramètres de la mascotte">
                    ...
                    <div className="mt-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'discret' ? 'bg-primary/15 border-primary text-foreground' : 'bg-muted border-border text-muted-foreground'}`}
                          onClick={() => handleIronBuddyLevelChange('discret')}
                        >Discret</button>
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'normal' ? 'bg-primary/15 border-primary text-foreground' : 'bg-muted border-border text-muted-foreground'}`}
                          onClick={() => handleIronBuddyLevelChange('normal')}
                        >Normal</button>
                        <button
                          className={`px-3 py-1 rounded-lg font-semibold border ${ironBuddyLevel === 'ambianceur' ? 'bg-primary border-primary text-primary-foreground' : 'bg-muted border-border text-muted-foreground'}`}
                  ...
                  <div>
                    ...
                    <button onClick={handleSupport} className="w-full text-left p-4 border border-border rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors flex items-center space-x-3 mb-2" aria-label="Contacter le support client">
                    ...
                    <button onClick={handleFAQ} className="w-full text-left p-4 border border-border rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors flex items-center space-x-3" aria-label="Consulter la foire aux questions">
                      <HelpCircle className="h-5 w-5 text-safe-info" />
                      <div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-2 p-3 bg-muted rounded-lg border border-border">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mt-3">
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'ironbuddy' ? 'border-primary bg-primary/10' : 'border-border bg-card'}`}
                    ...
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'cat' ? 'border-primary bg-primary/10' : 'border-border bg-card'}`}
                    ...
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'bot' ? 'border-primary bg-primary/10' : 'border-border bg-card'}`}
                    ...
                    <button
                      className={`flex flex-col items-center px-2 sm:px-3 py-2 rounded-lg border-2 transition-all ${selectedMascot === 'star' ? 'border-primary bg-primary/10' : 'border-border bg-card'}`}

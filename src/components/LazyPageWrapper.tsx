...
export function LazyDashboardSkeleton() {
 ...
 <div className="h-8 bg-card border border-border /20 rounded w-1/3 mb-2"></div>
 <div className="h-4 bg-card border border-border /20 rounded w-1/2"></div>
 </div>
 </div>
 ...
 <div key={i} className="bg-card border border-border rounded-xl p-6 shadow-md">
 <div className="animate-pulse">

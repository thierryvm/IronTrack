    ...
    <div className="relative">
      <div className="bg-gradient-to-r from-orange-600 to-red-500 dark:from-orange-500 dark:to-red-400 rounded-2xl p-6 text-white shadow-lg">
        <div className="absolute top-0 left-0 right-0 h-2 bg-orange-700/30 dark:bg-orange-600/30 rounded-t-2xl overflow-hidden">
          <div
            className="h-full bg-yellow-300 dark:bg-yellow-400 transition-all duration-1000 ease-in-out"
        ...
        {showControls && (
          <div className="flex justify-center space-x-4">
            {!isRunning ? (
              <button
                onClick={startTimer}
                className="bg-green-500 dark:bg-green-600 hover:bg-green-600 dark:hover:bg-green-700 p-3 rounded-full transition-colors min-h-[44px] min-w-[44px] hover:scale-105 transition-transform"
                disabled={timeLeft === 0}
              >
              ...
              <button
                onClick={pauseTimer}
                className="bg-yellow-500 dark:bg-yellow-600 hover:bg-yellow-600 dark:hover:bg-yellow-700 p-3 rounded-full transition-colors min-h-[44px] min-w-[44px] hover:scale-105 transition-transform"
              >
            ...
            <button
              ...
              className={`p-3 rounded-full transition-colors min-h-[44px] min-w-[44px] hover:scale-105 transition-transform ${
                isMuted 
      ...
      {showNotification && (
        <div className="absolute -top-20 left-1/2 transform -translate-x-1/2 bg-green-500 dark:bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg animate-pulse">
      ...
      <div className="grid grid-cols-3 gap-2">
        {quickTimes.map((time) => (
          <button
            ...
            className="bg-orange-600 dark:bg-orange-600 hover:bg-orange-700 dark:hover:bg-orange-700 text-white py-2 px-0 rounded-lg transition-colors text-sm font-bold w-full min-h-touch-44"
            style={{minWidth: 0}}
          >
            {time}s
          </button>
              ...
              <CardContent className="p-0">
                {recentExercises.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <Button asChild size="sm" variant="secondary" className="w-full mt-3 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 hover:bg-orange-200 dark:hover:bg-orange-900/50 border border-orange-200 dark:border-orange-700">

...
export const SupportTicketForm2025: React.FC<SupportTicketForm2025Props> = ({
 ...
 return'border-border bg-card text-gray-700 hover:border-border dark:border-border hover:bg-muted'
}
 ...
 className={`bg-card rounded-xl shadow-sm border border-border p-8 text-center ${className}`}
 >
 <motion.div
 initial={{ scale: 0}}
 animate={{ scale: 1}}
 ...
 <h3 className="text-2xl font-bold text-foreground mb-2">Ticket envoyé avec succès !</h3>
 ...
 >
 {/* Header */}
 <div className="bg-gradient-to-r from-orange-50 to-red-50 border-b border-border p-6">
 ...
 <p className="text-xs text-gray-600">Sélectionnez la catégorie qui correspond le mieux à votre demande</p>
 ...
 <p className="text-xs text-gray-600">Ajoutez des captures d'écran pour nous aider à mieux comprendre votre problème (optionnel)</p>
 ...
 animate={{ opacity: 1, y: 0}}
 exit={{ opacity: 0, y: -10}}
 className="flex items-center justify-between bg-background rounded-lg p-2 border border-border"
 >
 <div className="flex items-center space-x-2">

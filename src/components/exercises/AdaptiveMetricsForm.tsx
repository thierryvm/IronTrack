...
export function AdaptiveMetricsForm({
 ...
 <h4 className="font-semibold text-foreground">Métriques Rameur</h4>
 </div>
 ...
 <h4 className="font-semibold text-foreground">Métriques Course</h4>
 </div>
 ...
 <h4 className="font-semibold text-foreground">Métriques Vélo</h4>
 </div>
 ...
 <h4 className="font-semibold text-foreground">Métriques HIIT</h4>
 </div>
...
'Circuit training'}
 ...
 <h4 className="font-semibold text-foreground">Métriques Avancées</h4>
 </div>

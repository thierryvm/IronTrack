...
export const PerformanceEditForm: React.FC<PerformanceEditFormProps> = ({ 
 ...
 {/* Header */}
 <div className="sticky top-0 z-10 bg-card border border-border border-b border-border px-4 py-2">
 ...
 >
 {/* Info exercice */}
 <div className="flex items-center gap-2 mb-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
 ...
 className="w-20 sm:w-24 px-2 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary text-sm"
 >
 ...
 <div className="border-t pt-4">
 <h4 className="text-md font-medium text-foreground mb-2">Métriques rameur</h4>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-foreground mb-2">
 Coups/minute (SPM)
 ...
 <div className="border-t pt-4">
 <h4 className="text-md font-medium text-foreground mb-2">Métriques course/tapis</h4>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-foreground mb-2">
 ...
 <div className="border-t pt-4">
 <h4 className="text-md font-medium text-foreground mb-2">Métriques vélo</h4>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium text-foreground mb-2">
 Cadence (RPM)
 ...
 <button
 onClick={handleCancel}
 className="bg-muted text-foreground py-2 px-6 rounded-lg font-semibold hover:bg-muted transition-colors"
 >
 Annuler
 </button>
 <button
 onClick={handleSave}
 disabled={saving}
 className="bg-primary text-white py-2 px-6 rounded-lg font-semibold hover:bg-primary-hover transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
 >

...
export const ExerciseDuplicateModal: React.FC<ExerciseDuplicateModalProps> = ({
 ...
 <button
 onClick={onClose}
 className="w-8 h-12 rounded-full hover:bg-muted flex items-center justify-center transition-colors"
 aria-label="Fermer"
 >
 <X className="w-4 h-4" />
 </button>
 ...
 className="text-left bg-green-50 border border-green-200 rounded-lg p-2 hover:bg-success/10 transition-colors"
 >
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-foreground bg-muted rounded-lg hover:bg-muted transition-colors font-medium"
 >
 Annuler
 </button>
 {!hasExactMatch && (

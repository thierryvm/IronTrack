  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center justify-between pt-6 border-t border-border/50">
          ...
          >
            {isLoading ? (
              <>
                <div className="w-4 h-4 mr-2 animate-spin rounded-full border-2 border-white dark:border-gray-700/30 border-t-white" aria-hidden="true" />
                Enregistrement...
              </>
            ) : (
              <>
      ...
      <motion.div
        ...
        className="mt-8 p-4 bg-green-50 dark:bg-green-950/50 rounded-lg border border-green-200 dark:border-green-800"
        role="complementary"

...
export const FinalSummaryModal: React.FC<FinalSummaryModalProps> = ({
 ...
 className="bg-card border border-border rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-auto"
 ...
 <div className="mt-4 p-2 bg-card border border-border rounded-lg border border-orange-200">

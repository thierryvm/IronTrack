...
export const CustomForm: React.FC<CustomFormProps> = ({ 
 ...
 <div className="inline-flex items-center gap-2 px-2 py-1 bg-background rounded-full border">
 ...
 className={`p-2 rounded-lg border-2 font-medium transition-all duration-200 ${
 formData.difficulty === difficulty
 ? getDifficultyColor(difficulty)
 :'border-border bg-card text-gray-700 hover:bg-muted'
}`}
 >
 {difficulty}
 </button>
 ...
 className="space-y-4"
 >
 <h4 className="text-lg font-medium text-foreground border-b pb-2">Valeurs recommandées par défaut</h4>
 ...
 disabled={loading}
 className="flex-1 bg-green-500 text-white py-2 px-6 rounded-lg font-semibold hover:bg-green-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
 >
 ...
 type="submit"
 disabled={loading}
 className="flex-1 bg-primary text-white py-2 px-6 rounded-lg font-semibold hover:bg-primary-hover transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
 >

...
'Échauffement':'de préparation'
 ...
 className="flex items-center gap-2 mb-6 p-2 bg-green-50 rounded-lg border border-green-200"
 >
 ...
 initial={{ opacity: 0, y: 20}}
 animate={{ opacity: 1, y: 0}}
 className="text-center py-8 px-4 border border-border rounded-xl bg-background"
 >
 ...
 whileTap={{ scale: 0.98}}
 onClick={onCreateCustom}
 className="w-full p-6 border-2 border-dashed border-border rounded-xl

...
'oignon': 150
 ...
 <h3 className="text-xl font-bold text-foreground">Sélectionnez vos ingrédients</h3>
 <p className="text-muted-foreground">Recherchez et ajoutez les ingrédients de votre repas</p>
 </div>
 ...
 <h4 className="font-medium text-foreground">Ingrédients sélectionnés ({ingredients.length})</h4>
 {ingredients.map((ingredient) => (
 <div key={ingredient.id} className="flex items-center justify-between p-2 bg-muted rounded-lg">
 ...
 <div>
 <h5 className="font-medium text-foreground">{ingredient.food.name}</h5>
 ...
 <h3 className="text-xl font-bold text-foreground">Définissez les quantités</h3>
 <p className="text-muted-foreground">Ajustez les quantités pour chaque ingrédient</p>
 </div>
 ...
 return (
 <div key={ingredient.id} className="p-4 border border-border rounded-lg space-y-2">
 ...
 className="w-full px-2 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
 />
 </div>
 ...
 <p className="text-muted-foreground">glu</p>
 </div>
 <div className="text-center">
 ...
 <h3 className="text-xl font-bold text-foreground">Résumé et sauvegarde</h3>
 <p className="text-muted-foreground">Nommez votre repas et vérifiez les valeurs nutritionnelles</p>
 </div>
 ...
 className={`w-full px-2 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent ${
 ...
 className={`w-full px-2 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent ${
 errors.servings ?'border-red-500' :'border-border'
}`}
 />
 {errors.servings && (
 ...
 className="flex-1 px-2 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
 maxLength={30}
 />
 <button
 onClick={addTag}
 ...
 {tags.map((tag) => (
 <div key={tag} className="flex items-center space-x-1 px-2 py-1 bg-muted rounded-full">
 <Tag className="h-5 w-5 text-gray-600" />
 <span className="text-sm text-foreground">{tag}</span>
 <button
 onClick={() => removeTag(tag)}
 className="text-foreground hover:text-safe-error transition-colors"
 >
 ...
 <h4 className="font-medium text-foreground mb-2">Valeurs nutritionnelles totales</h4>
 ...
 <h4 className="font-medium text-foreground mb-2">Détail des ingrédients</h4>
 <div className="space-y-2">
 {ingredients.map((ingredient) => (
 ...
 className={`bg-card rounded-xl shadow-lg ${className}`}
 >
...
'Résumé'
 ...
 <button
 onClick={nextStep}
 className="flex items-center space-x-2 px-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-primary-hover transition-colors"
 >
 <span>Suivant</span>
 ...
 className="flex items-center space-x-2 px-4 py-2 bg-secondary text-white rounded-lg font-medium hover:bg-secondary transition-colors disabled:opacity-50"
 >
 {isSavingRecipe ? (
 <>

...
'Collation':'bg-green-100 text-green-800 border-green-200'
 ...
 <div className="flex items-center space-x-2">
 <div className="bg-card border border-border /20 rounded-lg p-2">
 ...
 <div className="text-xs text-safe-info">Protéines</div>
 </div>
 <div className="text-center p-2 bg-yellow-50 rounded-lg">
 <div className="text-lg font-semibold text-yellow-600">
 {Math.round(selectedDayStats.totalCarbs)}g
 </div>
 <div className="text-xs text-safe-warning">Glucides</div>
 </div>
 <div className="text-center p-2 bg-purple-50 rounded-lg">
 <div className="text-lg font-semibold text-purple-600">
 {Math.round(selectedDayStats.totalFat)}g
 </div>
 <div className="text-xs text-safe-primary">Lipides</div>
 </div>
 </div>
 ...
 <div className={`inline-flex items-center space-x-2 px-2 py-1 rounded-full text-sm font-medium border ${getMealTypeColor(mealType)} mb-4`}>
 <span>{getMealTypeIcon(mealType)}</span>
 <span>{mealType}</span>
 <span className="bg-card border border-border /50 px-2 py-1 rounded-full text-xs">

                ...
                <div className="lg:col-span-2">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 pr-4 py-2 focus:ring-2 focus:ring-orange-500"
                      ...
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        {hasPermission('moderator') && ticket.status === 'open' && (
                          <Button
                            ...
                            className="p-2 h-auto hover:text-orange-600 hover:bg-orange-50"
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {selectedTicket.attachments.map((attachment: {originalName?: string; type: string; size: number; url: string}, index: number) => (
                            ...
                            >
                              <div className="flex items-center space-x-3">
                                <Paperclip className="h-6 w-6 text-gray-700 dark:text-gray-300" />
                                <div>

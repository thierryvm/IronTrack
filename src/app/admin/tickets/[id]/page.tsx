...
export default function AdminTicketPage() {
 ...
 return (
 <div className="text-center py-12">
 <h3 className="text-lg font-medium text-foreground mb-2">Ticket non trouvé</h3>
 <p className="text-gray-600 mb-4">Ce ticket n'existe pas.</p>
 <Button variant="secondary" onClick={() => router.push('/admin/tickets')}>
 Retour aux tickets
 </Button>
 </div>
...
'bg-gray-100 text-gray-700'
 ...
 <h3 className="text-lg font-semibold text-foreground">Conversation ({responses.length})</h3>
 {responses.map((response) => (
 <div key={response.id} className="bg-card border border-border rounded-xl shadow-md p-6">
 ...
 {/* Contrôles Admin */}
 <div className="bg-card border border-border rounded-xl shadow-md p-6">
 <h3 className="text-lg font-semibold text-foreground mb-4">Gestion du ticket</h3>
 ...
 <div className="bg-card border border-border rounded-xl shadow-md p-6">
 <h3 className="text-lg font-semibold text-foreground mb-4">Répondre au ticket</h3>

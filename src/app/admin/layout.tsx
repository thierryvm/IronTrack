      ...
      <div className="lg:hidden bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between header-mobile-ios">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg py-2 z-50"
              >
      ...
      <div className="flex">
        ...
        {sidebarOpen && (
          <>
            ...
            <div
              className="lg:hidden fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-50 flex flex-col"
            >

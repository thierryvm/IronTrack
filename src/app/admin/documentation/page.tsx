  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Documentation Admin</h1>
        ...
        {/* Introduction */}
        <div className="bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-800 rounded-xl p-5 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sections.map((section) => {
            ...
            return (
              <Card key={section.title} className="border border-gray-200 dark:border-gray-700">
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center space-x-3 text-base">
                    <div className={`p-2 rounded-lg ${section.bg}`}>
                      <Icon className={`h-5 w-5 ${section.color}`} />
                    </div>
                    <span className="text-gray-900 dark:text-gray-100">{section.title}</span>
                  </CardTitle>
                </CardHeader>
                <CardContent>

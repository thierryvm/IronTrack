            ...
            <div className="relative z-10 p-8">
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-md border border-white/30 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center space-x-3 shadow-lg"
                >
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/10 backdrop-blur-md text-white/80 rounded-full">ou</span>
                </div>
              </motion.div>
              ...
              >
                <div className="text-center space-y-3 text-xs text-white/70">

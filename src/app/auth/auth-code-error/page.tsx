...
export default function AuthCodeErrorPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-600 via-red-500 to-purple-600 p-4">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700  rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 dark:text-safe-muted text-sm mb-4">Tu vas être redirigé automatiquement vers la page de connexion...</p>
        <button

    ...
    <div className="min-h-screen bg-background py-8 sm:py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-6 sm:space-y-8 text-muted-foreground text-sm sm:text-base">
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">1. Informations légales</h2>
              <div className="bg-muted border border-border p-3 sm:p-4 rounded-lg">
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">2. Responsable du traitement des données</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">3. Données collectées</h2>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">4. Finalités du traitement</h2>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">5. Base légale du traitement</h2>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">6. Durée de conservation</h2>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">7. Vos droits</h2>
              ...
              <p className="mt-4 text-sm bg-muted border border-border p-3 rounded-lg">
                Pour exercer ces droits, contactez-nous. Nous répondrons dans un délai de 30 jours calendaires.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">8. Sécurité des données</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">9. Cookies et Analytics</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-foreground mb-2">9.1 Cookies techniques essentiels</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">9.2 Analytics et amélioration des performances</h3>
                  ...
                  <div className="mt-3 text-sm bg-muted border border-border p-3 rounded-lg space-y-1">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-2">9.3 Aucun cookie publicitaire</h3>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">10. Modifications</h2>
              <p>Cette politique peut être mise à jour. Nous vous informerons de tout changement significatif.</p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">11. Contact</h2>
              <div className="bg-muted border border-border p-3 sm:p-4 rounded-lg">
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-3 sm:mb-4">12. Réclamations</h2>
              <p>
              ...
              <div className="bg-muted border border-border p-3 sm:p-4 rounded-lg mt-4">

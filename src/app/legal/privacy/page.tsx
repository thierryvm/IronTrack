...
export default function PrivacyPolicy() {
 ...
 <section>
 <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-4">8. Sécurité des données</h2>
 <p>
 ...
 <section>
 <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-4">9. Cookies et Analytics</h2>
 <div className="space-y-4">
 <div>
 ...
 <section>
 <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-4">10. Modifications</h2>
 <p>Cette politique peut être mise à jour. Nous vous informerons de tout changement significatif.</p>
 </section>

 <section>
 <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-4">11. Contact</h2>
 <div className="bg-muted border border-border p-2 sm:p-4 rounded-lg">
 ...
 <section>
 <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-4">12. Réclamations</h2>
 <p>

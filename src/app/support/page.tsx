...
export default function SupportPage() {
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">📱 Étape 1 : Accéder à Training Partners</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🔍 Étape 2 : Rechercher et Inviter des Partenaires</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">⚙️ Étape 5 : Gérer vos Partenaires</h3>
 <div className="space-y-4">
 <div className="border border-border rounded-lg p-4">
 ...
 {/* Dépannage */}
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🔧 Problèmes Courants</h3>
 <div className="space-y-2">
 <details className="border border-border rounded-lg">
 <summary className="p-2 cursor-pointer font-medium text-foreground hover:bg-muted">
 &quot;Je ne trouve pas mon ami dans la recherche&quot;
 </summary>
 <div className="p-2 pt-0 text-sm text-foreground">
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🏋️ Créer une Séance</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">📊 Suivre sa Progression</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🎯 Créer des objectifs</h3>
 <div className="space-y-4">
 <div className="border border-border rounded-lg p-4">
 ...
 {/* Problèmes courants */}
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🔧 Problèmes fréquents</h3>
 <div className="space-y-2">
 <details className="border border-border rounded-lg">
 <summary className="p-2 cursor-pointer font-medium text-foreground hover:bg-muted">
 ...
 <div className="space-y-6">
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">👤 Modifier votre Profil</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🔒 Sécurité & Confidentialité</h3>
 <ul className="list-disc list-inside space-y-1 text-foreground">
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">⚙️ Paramètres</h3>
 ...
 <div className="space-y-6">
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">🎯 Première Configuration</h3>
 ...
 <section>
 <h3 className="text-lg font-semibold text-foreground mb-2">❓ FAQ Onboarding</h3>
 <div className="space-y-2">
 <div className="border border-border rounded-lg p-4">
